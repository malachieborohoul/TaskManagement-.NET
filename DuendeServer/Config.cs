    ...
    public static IEnumerable<Client> Clients =>
        new Client[]
        {
            ...
            new Client
            {
                ...
                RedirectUris = {"http://172.105.109.209:7159/authentication/login-callback","http://localhost:7159/authentication/login-callback" },
                //PostLogoutRedirectUris = { "http://172.105.109.209:7159/authentication/logout-callback"  },
               PostLogoutRedirectUris = { "http://172.105.109.209:7159/authentication/logout-callback", "http://localhost:7159/authentication/logout-callback"  },
               Enabled = true,

               //AllowedCorsOrigins = {"http://172.105.109.209:7159" },
                AllowedCorsOrigins = {"http://172.105.109.209:7159", "http://localhost:7159" },
            }
        };
}